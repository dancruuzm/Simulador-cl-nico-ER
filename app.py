...
def evaluate_user(chat_history, caso_real, contexto_guias):
    ...
    system_prompt = (
        ...
        "- REGLA DE ORO: NUNCA empieces tu respuesta diciendo lo que vas a hacer (ej. 'We must respond with...'). COMIENZA DIRECTAMENTE HABLANDO CON EL ESTUDIANTE. Omitir pensamientos internos y etiquetas XML es obligatorio.\n"
